const elementos = {
    telaInicia: document.getElementById('inicial'),
...
const palavras = {
    opcao1: facil = novaPalavra.querySelector(".cadastro"),
    opcao2: medio = novaPalavra.querySelector(".cadastro"),
    opcao3: dificil = novaPalavra.querySelector(".cadastro"),
  ...
  elementos.botoes.cadastrar.addEventListener('click', () => novoJogo());
